...
起動時に貼ったパネルを「停止しました」に書き換え、ログに「終了しました」を残してから終わる。
...
- **止めるときは Ctrl+C のほうがよい。** 「終了しました」が記録され、起動時に貼ったパネルも「停止しました」になる。
...
- 止まるときは、そのパネルを「停止しました。またね！」に書き換えてボタンを外す。停止中に押されて「応答しませんでした」になるのを防ぐ
